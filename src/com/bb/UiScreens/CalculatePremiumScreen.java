...
public class CalculatePremiumScreen extends MainScreenClass {
	...
	public CalculatePremiumScreen(String calculateIdv, final String pBussType, final String pUserName,
		...
		b1.setBgColor(0x000072BC);
		b1.setMargin(5, 10, 0, 10);
		commDiscEdit = new EditField("", "", 3, FIELD_HCENTER | FOCUSABLE | EditField.FILTER_NUMERIC) {
			protected void paintBackground(Graphics g) {
				g.clear();
				if (isFocus()) {
					g.setColor(0x000072BC);
		...
		coverElectEdit = new EditField("", "", 12, FIELD_HCENTER | FOCUSABLE | EditField.FILTER_NUMERIC) {
			protected void paintBackground(Graphics g) {
				g.clear();
		...
		nonElecAccEdit = new EditField("", "", 12, FIELD_HCENTER | FOCUSABLE | EditField.FILTER_NUMERIC) {
			protected void paintBackground(Graphics g) {
				g.clear();
		...
		cngEdit = new EditField("", "", 12, FIELD_HCENTER | FOCUSABLE | EditField.FILTER_NUMERIC) {
			protected void paintBackground(Graphics g) {
				g.clear();
		...
		assCoverEdit = new EditField("", "", 12, FIELD_HCENTER | FOCUSABLE | EditField.FILTER_NUMERIC) {
			protected void paintBackground(Graphics g) {
				g.clear();
			...
			public void fieldChanged(Field field, int context) {
				if (field == btnCalPrem) {
					...
					if (calculatedIDVEdit.getText().equals("")) {
						calculatedIDVEdit.setText(calculateIdvv);
					}
					if (commDiscEdit.getText().equals("")) {
						commDiscEdit.setText("0");
					}
					if (coverElectEdit.getText().equals("")) {
						coverElectEdit.setText("0");
					}
					if (nonElecAccEdit.getText().equals("")) {
						nonElecAccEdit.setText("0");
					}
					if (cngEdit.getText().equals("")) {
						cngEdit.setText("0");
					}
					if (assCoverEdit.getText().equals("")) {
						assCoverEdit.setText("0");
					}
